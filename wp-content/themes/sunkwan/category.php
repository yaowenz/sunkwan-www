...
<div class="primary content news">
	...
	<div class="wrapper">
		<div class="article left">
					...
					<li>
						<div class="thumb">
							<a href="<?php echo get_permalink(); ?>"><img
								src="<?php echo the_post_thumbnail_url();?>" width="100%" /></a>
						</div>
						<div class="brief">
							<p>
			...
			array('screen_reader_text' => ' ', 'prev_text' => '上一页', 'next_text' => '下一页'));
			?>			
		</div>
		<div class="article side">
			<div class="ad">
				<img
					src="<?php echo get_template_directory_uri()?>/images/ads/side-ad-1.jpg" />
			</div>
		</div>
